...
# Disconnects the database and ends the program
def disconnect_and_quit
  $db.close
  puts "Bye!"
  exit
end
# Creates the table where data is stored
def create_table
...
# Gets user input and adds new person to database
def add_person
  puts "Enter name:"
  name = gets.chomp
  puts "Enter job:"
...
# Retrieves associated data from a user-given name and ID
def find_person
